...
void Level5State::OnEnter(Game2D& app)
{
    Window::HideCursor();
}
...
void Level5State::OnHandle(Game2D& app)
{
...
void Level5State::OnUpdate(Game2D& app)
{
    // Update Pause Menu
    // =================
...
void Level5State::OnRender(Game2D& app)
{
...
void Level5State::OnExit(Game2D& app)
{
    SaveFileData data;
