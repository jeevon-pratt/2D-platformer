...
void Level5State::OnEnter(Game2D& game)
{
    // No Functionality
}
...
void Level5State::OnHandle(Game2D& game)
{
...
void Level5State::OnUpdate(Game2D& game)
{
...
void Level5State::OnRender(Game2D& game)
{
...
void Level5State::OnExit(Game2D& game)
{
    SaveFileData data;
    data.level        = LEVEL_5_STATE;
...
void Level5State::ProcessButtonEvents(Game2D& game, const SDL_Event& event)
{
