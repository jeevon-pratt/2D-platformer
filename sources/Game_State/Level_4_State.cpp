...
void Level4State::OnEnter(Game2D& game)
{
    // No Functionality
}
...
void Level4State::OnHandle(Game2D& game)
{
...
void Level4State::OnUpdate(Game2D& game)
{
...
void Level4State::OnRender(Game2D& game)
{
...
void Level4State::OnExit(Game2D& game)
{
    SaveFileData data;
...
void Level4State::ProcessButtonEvents(Game2D& game, const SDL_Event& event)
{
