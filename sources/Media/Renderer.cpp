...
static constexpr uint32_t INIT_FLAGS = SDL_RENDERER_ACCELERATED | SDL_RENDERER_PRESENTVSYNC;
...
Renderer::Renderer(const Window& window)
{
    ...
    m_rendererContext = SDL_CreateRenderer(windowContext, INDEX, INIT_FLAGS);
